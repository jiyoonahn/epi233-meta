...
meta_ran<-metabin(event_steroid_stridor,n_steroid_stridor,event_control_stridor,n_control_stridor,data=edema_rct_str,studlab=paste(author,year),comb.fixed=F,comb.random=T,sm="OR",method.tau = "EB",method="peto")
forest(meta_ran,lab.e="Steroid")
