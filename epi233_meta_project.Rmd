...
meta_fix <- metabin(event_steroid_stridor,n_steroid_stridor,event_control_stridor,n_control_stridor,data=sens,studlab=paste(author,year),comb.fixed=T,comb.random=F,sm="OR", methods = "Peto")
forest(meta_fix,lab.e="Steroid")
```
