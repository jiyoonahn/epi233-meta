...
#Forest
#Fixed-effect
meta_fix<-metabin(event_steroid_stridor,n_steroid_stridor,event_control_stridor,n_control_stridor,data=edema_rct_str,studlab=paste(author),comb.fixed=T,comb.random=F,sm="OR")
forest(meta_fix)
...
write.csv(edema_rct_reint,"b.csv")
as_tibble(edema_rct_reint)
```
