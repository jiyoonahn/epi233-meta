...
#Forest
```{r}
meta_fix<-metabin(event_steroid_reintubation,n_steroid_reintubation,event_control_reintubation,n_control_reintubation,data=edema,studlab=paste(author),comb.fixed=T,comb.random=F,sm="RR")
forest(meta_fix)

meta_ran<-metabin(event_steroid_reintubation,n_steroid_reintubation,event_control_reintubation,n_control_reintubation,data=edema,studlab=paste(author),comb.fixed=F,comb.random=T,sm="RR",method.tau = "EB")
forest(meta_ran)
